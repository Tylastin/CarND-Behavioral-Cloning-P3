![alt text](./examples/center_lane_driving.png)
...
This deep learning project, implements a convolutional neural network (CNN) based on an [architecture developed by NVIDIA](https://devblogs.nvidia.com/deep-learning-self-driving-cars/), to clone driving behavior. The model is trained, validated and tested using Keras. The model outputs a steering angle to an autonomous vehicle.
...
* drive.py (script to drive the ca)
* model.h5 (a trained Keras model)
* writeup_report.md (a detailed writeup)
